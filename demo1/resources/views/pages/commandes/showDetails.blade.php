...
<div class="container">
  ...
  <ul class="responsive-table">
    <li class="table-header">
      ...
      <div class="col col-7">Id client</div>
    ...
    <li class="table-row">
      ...
      <div class="col col-7" data-label="nom prodduit">{{$commande->id_client}}</div>
    ...
    <form action="{{ route('confirmer', ['id' => $commande->id_client]) }}" method="POST" >
        @csrf
        <button type="submit" class="btn btn-outline-primary" style="width: 500px;margin-left: 340px;">Confirmer </button>
    </form>
</div>
              @endif
