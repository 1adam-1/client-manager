...
<body> 
<div>
  <form class="search-form" action="{{ route('searchAirlodAvis') }}" method="post" style="margin-top: 10vh;margin-left:328px;margin-bottom:10px;width:70%;">
    @csrf
    <div class="row">
      <div class="col-md-12">
...
@endif
    ...
    <div class="title">Airlod avis Entrée</div>
    <div>
    <h4 style="margin-left:300px">New ND : ND{{$nextNumber}}</h4>
    </div>
    </div>
    <div class="content">
    <form class="forms-sample" action="{{ route('createClientAirlodAvis') }}" method="POST" enctype="multipart/form-data">
  @csrf
  <div class="user-details">
    ...
    <div class="input-box">
      <span class="details">Campagne pub</span>
            ...
            <div class="col-md-3">
              <section class="card card-blue product-card" data-product-id="{{ $product->id }}">
                ...
                <div class="radio-select" >
                  ...
                  <label class="btn btn-outline-dark radio-label" for="btn-check-{{ $product->id }}" style="color:#00E01A;border:2px solid #00E01A">
